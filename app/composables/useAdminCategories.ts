      ...
      if (assets) {
        categoryAssetsList.value = assets.map((item: any) => {
          ...
          return {
            ...
            cardTitleFontFamily: settings.card_title_font_family || 'Calibri',
            cardModelFontFamily: settings.card_model_font_family || 'Calibri',
            ...
            cardModelLabelFontFamily: settings.card_model_label_font_family || 'Calibri',
