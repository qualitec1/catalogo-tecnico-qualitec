      ...
      if (assets) {
        categoryAssetsList.value = assets.map((item: any) => {
          ...
          return {
            ...
            coverTitleEs: (settings.layout_settings && (settings.layout_settings.cover_title_es || settings.layout_settings.cover_title_de)) || settings.cover_title_es || settings.cover_title_de || '',
            coverTitleDe: (settings.layout_settings && (settings.layout_settings.cover_title_es || settings.layout_settings.cover_title_de)) || settings.cover_title_es || settings.cover_title_de || '',
            coverSubtitlePt: (settings.layout_settings && settings.layout_settings.cover_subtitle_pt) || settings.cover_subtitle_pt || '',
            coverSubtitleEn: (settings.layout_settings && settings.layout_settings.cover_subtitle_en) || settings.cover_subtitle_en || '',
            coverSubtitleEs: (settings.layout_settings && settings.layout_settings.cover_subtitle_es) || settings.cover_subtitle_es || '',
    ...
    try {
      ...
      const settingsPayload = {
        ...
        layout_settings: {
          ...
          cover_title_de: catAsset.coverTitleEs || catAsset.coverTitleDe || null,
          cover_subtitle_pt: catAsset.coverSubtitlePt || null,
          cover_subtitle_en: catAsset.coverSubtitleEn || null,
          cover_subtitle_es: catAsset.coverSubtitleEs || null,
        },
  ...
  const replicateCategorySettings = async ({ source, targetIds, fields, density }: { source: any, targetIds: string[], fields?: string[] | null, density?: string }) => {
    ...
    try {
      ...
      const fieldToDbCol: Record<string, string> = {
        ...
        coverTitlePt: 'cover_title_pt',
        coverTitleEn: 'cover_title_en',
        coverTitleEs: 'cover_title_es',
        coverSubtitlePt: 'cover_subtitle_pt',
        coverSubtitleEn: 'cover_subtitle_en',
        coverSubtitleEs: 'cover_subtitle_es',
