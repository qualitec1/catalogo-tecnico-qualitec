  ...
  <div class="min-h-screen bg-slate-100 font-sans text-slate-800 pb-12">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
      ...
      <div class="flex border-b border-gray-200 bg-white p-2 rounded shadow-sm mb-6 flex-wrap gap-2">
        ...
        <button @click="currentTab = 'traducoes'" :class="currentTab === 'traducoes' ? 'bg-blue-700 text-white font-bold' : 'text-slate-600 hover:bg-slate-100 font-semibold'" class="px-6 py-2.5 text-xs uppercase tracking-wider rounded transition-colors border-0 cursor-pointer flex items-center gap-1">
          <span class="material-symbols-outlined text-base">translate</span>
          Traduções
        </button>
        <button @click="currentTab = 'novidades'" :class="currentTab === 'novidades' ? 'bg-emerald-700 text-white font-bold' : 'text-slate-600 hover:bg-slate-100 font-semibold'" class="px-6 py-2.5 text-xs uppercase tracking-wider rounded transition-colors border-0 cursor-pointer flex items-center gap-1">
        ...
        <button @click="currentTab = 'contatos'" :class="currentTab === 'contatos' ? 'bg-[#004A96] text-white font-bold' : 'text-slate-600 hover:bg-slate-100 font-semibold'" class="px-6 py-2.5 text-xs uppercase tracking-wider rounded transition-colors border-0 cursor-pointer flex items-center gap-1">
      ...
      <!-- Tab: Traduções -->
      <div v-show="currentTab === 'traducoes'">
        <AdminTranslations
          :trigger-toast="triggerToast"
        />
      </div>
