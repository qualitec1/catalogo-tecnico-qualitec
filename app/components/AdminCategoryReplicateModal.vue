...
const replicationGroups = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'coverTitlePt', label: 'Título Capa (PT)' },
      { key: 'coverTitleEn', label: 'Título Capa (EN)' },
      { key: 'coverTitleEs', label: 'Título Capa (ES)' },
      { key: 'coverSubtitlePt', label: 'Subtítulo Capa (PT)' },
      { key: 'coverSubtitleEn', label: 'Subtítulo Capa (EN)' },
      { key: 'coverSubtitleEs', label: 'Subtítulo Capa (ES)' },
