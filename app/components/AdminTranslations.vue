...
const sections: SectionDef[] = [
  ...
  {
    key: 'home',
    label: 'Página Home (Conteúdo & Seções)',
    icon: 'home',
    description: 'Textos da página inicial (Hero, Busca Rápida, Novidades e Newsletter)',
    fields: [
      ...
      { key: 'home.search_title',         label: 'Título de Busca Rápida', hint: 'Ex: "Como podemos te ajudar?"' },
      { key: 'home.search_subtitle',      label: 'Subtítulo de Busca Rápida', hint: 'Ex: "Utilize a busca rápida e encontre sua necessidade"' },
      { key: 'home.search_quick_title',   label: 'Título Buscas Mais Utilizadas', hint: 'Ex: "Buscas mais utilizadas"' },
      { key: 'home.search_quick_1',       label: 'Link Rápido 1', hint: 'Ex: "Contato de vendas / suporte"' },
      { key: 'home.search_quick_2',       label: 'Link Rápido 2', hint: 'Ex: "Válvulas de Segurança"' },
      { key: 'home.search_quick_3',       label: 'Link Rápido 3', hint: 'Ex: "Reparos HEROSE"' },
      { key: 'home.search_quick_4',       label: 'Link Rápido 4', hint: 'Ex: "Transmissores de Pressão"' },
      { key: 'home.news_title',           label: 'Título da Seção Novidades', hint: 'Ex: "Novidades"' },
      { key: 'home.news_item1_title',     label: 'Novidade 1 - Título', hint: 'Ex: "Novo Catálogo"' },
      { key: 'home.news_item2_title',     label: 'Novidade 2 - Título', hint: 'Ex: "Transmissor de nível flangeado"' },
      { key: 'home.news_item3_title',     label: 'Novidade 3 - Título', hint: 'Ex: "Regulador Pressão CO2"' },
      { key: 'home.newsletter_title',     label: 'Título da Newsletter', hint: 'Ex: "Cadastre-se para receber nossa newsletter."' },
      { key: 'home.newsletter_label',     label: 'Rótulo do Campo Email', hint: 'Ex: "Digite seu email aqui *"' },
      { key: 'home.newsletter_button',    label: 'Botão da Newsletter', hint: 'Ex: "Inscrever"' },
    ]
  },
]
